...
<%
    ...
    {
        out.print("<script>alert('Deleted Successful');window.location.href='../showBooking.jsp';</script>");
    }
    else
    {
        out.print("<script>alert('Database error');window.location.href='../showBooking.jsp';</script>");
    }
