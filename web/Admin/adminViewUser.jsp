...
<body>
<div style="min-height:400px;width:100%;background-image:URL(../image/user.jpg);background-size:cover;box-shadow: 
...
<p style="font-size:60px;text-align:center;font-family: 'Roboto Mono', monospace;font-weight:bold;color:white;text-shadow: 3px 3px 6px black">Users</p>
...
<div class="row" style="min-height:100px;">
   ...
   <center>
        ...
        <%
            ...
            String output="select * from handregistration where type='user' Order by fname asc";
      ...
      <div class="card" style="width:80%;min-height:90%;border-radius:5px">
         ...
         <i class="fas fa-users" style='text-align: center;color:#82C91E;font-size: 40px'></i>
        ...
        <div class="card-content">
          ...
          <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bolder;">Address:&nbsp;<%=rs.getString(6)%></span><br>
           <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bolder;">City:&nbsp;<%=rs.getString(7)%></span><br>
            <a href="deleteCodeUser.jsp?id=<%=rs.getString(5)%>" style="text-align: center;color:#82C91E;font-size: 20px;font-family: 'Roboto Mono', monospace;font-weight: bold">Remove User</a>
            </p>
        </div>
