...
<body>
<div style="height: 730px;width:100%;background-image:URL(image/cleaning-services.jpg);background-size:cover;box-shadow: 
    ...
    <div class="container-fluid" style="min-height: 300px;">
        <div class="row">
            <div class="col s12 m12 l6" style="min-height: 300px;">
                <p style="font-size:70px;color:#983264;font-family: 'Roboto Mono', monospace;font-weight:bold;margin-top:100px;margin-left:50px;">Cleaning Services</p>
                <p style="font-size:60px;color:white;font-family: 'Roboto Mono', monospace;font-weight:bold;margin-left:50px;">At Your Doorstep!</p>
        ...
        <div id="modal1" class="modal" style="height: 290px;">
            <div class="modal-content">
             ...
             <input type="hidden" value="Cleaning" name="service">
...
<footer class="page-footer" style="background-color: #151A23;">
    <div class="container" >
      <div class="row">
