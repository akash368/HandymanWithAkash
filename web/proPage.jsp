<%-- 
    Document   : proPage
    Created on : Apr 26, 2021, 6:45:45 PM
    Author     : ASUS
--%>
...
<body>
<div style="min-height:700px;width:100%;background-image:URL(image/new.jpg);box-shadow: 
  ...
  <section>
      ...
      <%
          ...
          String email=(String)session.getAttribute("semail");
            ...
            String serv="select * from handregistration where email='"+email+"'";
            ResultSet rs=cm.SelectQuery(serv);
            while(rs.next())
            {
                news=rs.getString(8);
                %>
          ...
          <%
            ...
            <%
            String output="select * from cart where service='"+news+"'";
            rs=cm.SelectQuery(output);
            while(rs.next())
            {%>
      ...
      <div class="card" style="width:80%;min-height:90%;border-radius:5px">
        ...
        <div class="card-content">
          ...
          <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bold;"><%=rs.getString(3)%></span>&nbsp; &nbsp; &nbsp; &nbsp;
          <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bold;">Service:&nbsp;<%=rs.getString(4)%></span>&nbsp; &nbsp; &nbsp; &nbsp;
          <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bold;">OrderId:&nbsp;<%=rs.getString(5)%></span>&nbsp; &nbsp; &nbsp; &nbsp;
          <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bolder;">Price:&nbsp;<%=rs.getString(6)%></span>&nbsp; &nbsp; &nbsp; &nbsp;
          <a href="code/deleteBookingPro.jsp?id=<%=rs.getString(1)%>" style="text-align: center;color:#82C91E;font-size: 20px;font-family: 'Roboto Mono', monospace;font-weight: bold">Delete</a>
            </p>
        </div>
