...
<body>
<div style="min-height:400px;width:100%;background-image:URL(../image/pro.jpg);background-size:cover;box-shadow: 
...
<p style="font-size:60px;text-align:center;font-family: 'Roboto Mono', monospace;font-weight:bold;color:white;text-shadow: 3px 3px 6px black">Professionals</p>
...
<div class="row" style="min-height:100px;">
   ...
   <center>
        ...
        <%
            ...
            String output="select * from handregistration where type='pro' Order by fname asc";
      ...
      <div class="card" style="width:80%;min-height:90%;border-radius:5px">
          <div class="card-image"><br><br>
         <i class="fas fa-user-tie" style='text-align: center;color:#82C91E;font-size: 40px'></i>
          
        </div>
        <div class="card-content">
            <p style='text-align:justify;'>
          <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bold">Name:&nbsp;<%=rs.getString(2)%></span>
          <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bold;"><%=rs.getString(3)%></span><br>
          <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bold;">Email:&nbsp;<%=rs.getString(5)%></span><br>
          <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bold;">City:&nbsp;<%=rs.getString(7)%></span><br>
          <span style="font-size: 15px;font-family: 'Roboto Mono', monospace;font-weight: bolder;">Service:&nbsp;<%=rs.getString(8)%></span><br><br>
          <a href="deleteCode.jsp?id=<%=rs.getString(5)%>" style="text-align: center;color:#82C91E;font-size: 20px;font-family: 'Roboto Mono', monospace;font-weight: bold">Remove Pro</a>
            </p>
        </div>
