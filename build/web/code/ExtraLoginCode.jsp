...
<%
    ...
    session.setAttribute("sservice",service);
    //out.print(service);
    ...
    if(rs.next())
    {
        ...
        // for user
         //session.invalidate();
        out.print("<script>alert('Welcome User');window.location.href='../booking.jsp';</script>");
        }
        else
            if(utype.equals("admin"))
            {
                //for admin
                out.print("<script>alert('Welcome Admin');window.location.href='../admin.jsp';</script>");
            }
    ...
    {
        out.print("<script>alert('Please Login First');window.location.href='../ExtraLogin.jsp'</script>");
    }
%>
