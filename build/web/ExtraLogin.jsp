...
<a href="#" data-target="slide-out" class="sidenav-trigger"><i class="material-icons">menu</i></a>
    <div class="nav-wrapper">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="login.html" class="menu-text">LOGIN/SIGNUP</a></li>
      </ul>
    </div>
  </nav>
<ul id="slide-out" class="sidenav">
  ...
  <div class="container" style="padding-bottom: 50px;">
    <div class="row">
                <div class="col-lg-5" style="min-height: 400px;background-color:rgba(255, 255, 255, .15);  
                  backdrop-filter: blur(5px);"><br>
                        <p style="font-family: 'Roboto Mono', monospace;color: white;font-size: 30px;font-weight: bold;text-align: center;">Login</p>
                        <br><br><br><br>
                      <div class="row">
                          <%
            ...
            %>
                          ...
                          <form class="col s12" action="code/ExtraLoginCode.jsp" method="post">
                                <div class="row">
                                  <div class="input-field col s6">
                                    
                                <input id="icon_prefix" type="text" class="validate" name="email">
                                <label for="icon_prefix" style="font-family: 'Roboto Mono', monospace;color: white;font-size: 15px;">UserId Or Email Id</label>
                              </div>
                            </div>
                            <div class="row">
                            <div class="input-field col s6">
                              ...
                              <label for="icon_telephone" style="font-family: 'Roboto Mono', monospace;color: white;font-size: 15px;">Password</label>
                            </div>
                ...
                <div class="col-lg-1" style="min-height: 200px;">

                </div>

                <div class="col-lg-6" style="min-height: 400px;background-color: rgba(255, 255, 255, .15); backdrop-filter: blur(5px);">
                  <br>
                  <p style="font-family: 'Roboto Mono', monospace;color: white;font-size: 30px;font-weight: bold;text-align: center;">Registration</p>
                        <br>
                    
                        <div class="row">
                          <form class="col s12" action="code/registrationCode.jsp" method="post">
                            <div class="row">
                              <div class="input-field col s6">
                            ...
                            <div class="row">
                              <div class="col s12">
                                <div class="input-field col s6">
                                  ...
                                  <label for="Complete address" style="font-family: 'Roboto Mono', monospace;color: white;font-size: 15px;">Complete Address</label>
                                </div>
                                <div class="input-field col s6">
                                  <input id="last_name" type="text" class="validate" name="city">
                                  <label for="city" style="font-family: 'Roboto Mono', monospace;color: white;font-size: 15px;">City</label>
                                </div>
                              </div>
                            </div>
                            <button style="height: 50px; width: 100px; background-color: #219DF3; color:white;font-size: 15px;font-family: 'Roboto Mono', monospace;border: none;font-weight: bold;">
