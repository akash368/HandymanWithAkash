...
<body>
<div style="min-height:700px;width:100%;background-image:URL(image/last.jpg);box-shadow: 
  ...
  <section>
      ...
      <%
          String email=(String)session.getAttribute("semail");
            ...
            String output="select * from cart where email='"+email+"'";
      ...
      <div class="card" style="width:80%;min-height:90%;border-radius:5px">
        ...
        <div class="card-content">
          ...
          <a href="code/deleteBooking.jsp?id=<%=rs.getString(1)%>" style="text-align: center;color:#82C91E;font-size: 20px;font-family: 'Roboto Mono', monospace;font-weight: bold">Delete</a>
            </p>
        </div>
