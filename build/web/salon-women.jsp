...
<body>
<div style="height: 730px;width:100%;background-image:URL(image/women-salon.jpg);background-size:cover;box-shadow: 
    ...
    <div class="container-fluid" style="min-height: 300px;">
        <div class="row">
            <div class="col s12 m12 l6" style="min-height: 300px;">
                <p style="font-size:70px;color:#AF0D49;font-family: 'Roboto Mono', monospace;font-weight:bold;margin-top:100px;margin-left:50px;">Women Salon</p>
                <p style="font-size:60px;color:white;font-family: 'Roboto Mono', monospace;font-weight:bold;margin-left:50px;">At Home</p>
        ...
        <div id="modal1" class="modal" style="height: 290px;">
            <div class="modal-content">
             ...
             <input type="hidden" value="Women Salon" name="service">
