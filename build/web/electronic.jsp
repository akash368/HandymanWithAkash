...
<body>
<div style="height: 730px;width:100%;background-image:URL(image/electric-service.jpg);background-size:cover;box-shadow: 
    ...
    <div class="container-fluid" style="min-height: 300px;">
        <div class="row">
            <div class="col s12 m12 l6" style="min-height: 300px;">
                <p style="font-size:70px;color:black;font-family: 'Roboto Mono', monospace;font-weight:bold;margin-top:100px;margin-left:50px;">Best Electric Services</p>
                <p style="font-size:60px;color:black;font-family: 'Roboto Mono', monospace;font-weight:bold;margin-left:50px;">You Deserve</p>
        ...
        <div id="modal1" class="modal" style="height: 290px;">
            <div class="modal-content">
             ...
             <input type="hidden" value="Electrician" name="service">
...
<footer class="page-footer" style="background-color: #4B6793;">
    <div class="container" >
      <div class="row">
